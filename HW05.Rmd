...
vorino_AUC %>% 
  ggplot(aes(x = reorder(cancer_type, -area_under_curve), y = area_under_curve), ) +
    ...
    theme_classic() +
    theme(axis.text.x = element_text(angle = 45, hjust = 1))  #From an aesthetic perspective, the x-axis looks terrible. This could be fixed
                                                              #by using abbreviations for the cancer types
```
