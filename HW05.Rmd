...
```{r, echo = FALSE}
print(paste("Prostate cancer cell line 22RV1 is the most sensitve to", CTRP_df_q2$cpd_name[1]))
...
```{r, echo = FALSE}
print(paste("On average,", CTRP_df_q3$cpd_name[1], "has the lowest AUC value in the breast cancer cell lines"))
